...
export default function WebDesign() {
    return (
        <main className='margin-from-header'>
            ...
            <p>current version - see below or <a href='https://654288e9e53f790083af8d54--stunning-beignet-3638a9.netlify.app/' target='_blank' rel="noreferrer">open in new tab</a></p>
            <br />
            ...
            <br />
            <br />
            <p>previous version - see below or <a href='https://t20-v1-1-2--effortless-baklava-0b0295.netlify.app/' target='_blank' rel="noreferrer">open in new tab</a></p>
            <br />
