...
export default function WebDesign() {
    return (
        <main className='margin-from-header'>
            ...
            <p>current version - see below or <a href='https://ufr.netlify.app/' target='_blank' rel="noreferrer">open in new tab</a></p>
            <br />
            ...
            <br />
            <br />
            <p>previous version - see below or <a href='https://ufr-interrupted-version.netlify.app/' target='_blank' rel="noreferrer">open in new tab</a></p>
            <br />
